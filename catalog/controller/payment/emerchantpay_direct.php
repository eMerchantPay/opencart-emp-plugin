...
class ControllerPaymentEmerchantPayDirect extends ControllerPaymentEmerchantPayBase
{
	...
	public function index()
	{
		...
		if ($this->model_payment_emerchantpay_direct->isCartContentMixed()) {
	...
	public function send()
	{
		...
		try {
			...
			$data = array(
				...
				'currency' => $this->model_payment_emerchantpay_direct->getCurrencyCode(),
	...
	public function addOrderRecurring($payment_reference)
	{
		...
		if (!empty($recurring_products)) {
			$this->load->model('payment/emerchantpay_direct');
			$this->model_payment_emerchantpay_direct->addOrderRecurring(
				$recurring_products,
				$payment_reference
			);
		}
	...
	{
		$this->load->model('payment/emerchantpay_direct');
		$this->model_payment_emerchantpay_direct->processRecurringOrders();
	}
}
