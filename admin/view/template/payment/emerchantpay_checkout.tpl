    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-emerchantpay_checkout" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-emerchantpay_checkout" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-account"><?php echo $entry_username; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="emerchantpay_checkout_username" value="<?php echo $emerchantpay_checkout_username; ?>" placeholder="<?php echo $entry_username; ?>" id="input-account" class="form-control" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="emerchantpay_checkout_password" value="<?php echo $emerchantpay_checkout_password; ?>" placeholder="<?php echo $entry_password; ?>" id="input-secret" class="form-control" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="emerchantpay_checkout_token" value="<?php echo $emerchantpay_checkout_token; ?>" placeholder="<?php echo $entry_token; ?>" id="input-secret" class="form-control" />
                            <?php if ($error_password) { ?>
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <?php if ($emerchantpay_checkout_sandbox) { ?>
                                    <input type="radio" name="emerchantpay_checkout_sandbox" value="1" checked="checked" />
                                    <?php echo $text_yes; ?>
                                <?php } else { ?>
                                    <input type="radio" name="emerchantpay_checkout_sandbox" value="1" />
                                    <?php echo $text_yes; ?>
                                <?php } ?>
                            </label>
                            <label class="radio-inline">
                                <?php if (!$emerchantpay_checkout_sandbox) { ?>
                                    <input type="radio" name="emerchantpay_checkout_sandbox" value="0" checked="checked" />
                                    <?php echo $text_no; ?>
                                <?php } else { ?>
                                    <input type="radio" name="emerchantpay_checkout_sandbox" value="0" />
                                    <?php echo $text_no; ?>
                                <?php } ?>
                            </label>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="emerchantpay_checkout_transaction_type[]" id="input-order-status" class="form-control" multiple="multiple">
                                <?php foreach ($transaction_types as $transaction_type) { ?>
                                    <?php if (in_array($transaction_type['id'], $emerchantpay_checkout_transaction_type)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="emerchantpay_checkout_status" id="input-status" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="emerchantpay_checkout_debug" id="input-status" class="form-control">
