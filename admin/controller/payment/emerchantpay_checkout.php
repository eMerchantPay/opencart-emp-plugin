...
class ControllerPaymentEmerchantPayCheckout extends Controller
{
     ...
     * @var string
     */
    private $module_name = 'emerchantpay_checkout';
    ...
    public function index()
    {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            $data = array(
                ...
                'help_order_status_failure'     => $this->language->get('help_failure_order_status'),
                ...
                'transaction_types' => $this->model_payment_emerchantpay_checkout->getTransactionTypes(),
                ...
                'error_warning'              => $this->language->get("error_permission"),
                'error_controls_invalidated' => $this->language->get('error_controls_invalidated'),

                'action' => $this->url->link('payment/emerchantpay_checkout', 'token=' . $this->session->data['token'], 'SSL'),
                ...
                // Settings
                'emerchantpay_checkout_username' => $this->getFieldValue('emerchantpay_checkout_username'),
                'emerchantpay_checkout_password' => $this->getFieldValue('emerchantpay_checkout_password'),
                'emerchantpay_checkout_sandbox' => $this->getFieldValue('emerchantpay_checkout_sandbox'),
                'emerchantpay_checkout_transaction_type' => $this->getFieldValue('emerchantpay_checkout_transaction_type'),
                'emerchantpay_checkout_total' => $this->getFieldValue('emerchantpay_checkout_total'),
                'emerchantpay_checkout_order_status_id' => $this->getFieldValue('emerchantpay_checkout_order_status_id'),
                'emerchantpay_checkout_order_failure_status_id' => $this->getFieldValue('emerchantpay_checkout_order_failure_status_id'),
                'emerchantpay_checkout_geo_zone_id' => $this->getFieldValue('emerchantpay_checkout_geo_zone_id'),
                'emerchantpay_checkout_status' => $this->getFieldValue('emerchantpay_checkout_status'),
                'emerchantpay_checkout_sort_order' => $this->getFieldValue('emerchantpay_checkout_sort_order'),
                'emerchantpay_checkout_debug' => $this->getFieldValue('emerchantpay_checkout_debug'),
                'emerchantpay_checkout_supports_partial_capture' => $this->getFieldValue('emerchantpay_checkout_supports_partial_capture'),
                'emerchantpay_checkout_supports_partial_refund' => $this->getFieldValue('emerchantpay_checkout_supports_partial_refund'),
                'emerchantpay_checkout_supports_void' => $this->getFieldValue('emerchantpay_checkout_supports_void'),
            );

            $defaultParamValues = array(
                'emerchantpay_checkout_sandbox'                  => 1,
                'emerchantpay_checkout_status'                   => 0,
                'emerchantpay_checkout_debug'                    => 1,
                'emerchantpay_checkout_supports_partial_capture' => 1,
                'emerchantpay_checkout_supports_partial_refund'  => 1,
                'emerchantpay_checkout_supports_void'            => 1
            );
            ...
            $data['breadcrumbs'][] = array(
                'text' => $headingTitle,
                'href' => $this->url->link('payment/emerchantpay_checkout', 'token=' . $this->session->data['token'], 'SSL')
            );

            $this->response->setOutput(
                $this->load->view('payment/emerchantpay_checkout.tpl', $data)
            );
        }
    }
    ...
    /**
     * Get transactions list (openCart 2.0.x)
     *
     * @return mixed
     */
    public function orderAction()
    {
        if ($this->config->get('emerchantpay_checkout_status')) {
            ...
            $transactions = $this->model_payment_emerchantpay_checkout->getTransactionsByOrder($orderId);
            ...
            if ($transactions) {
                ...
                foreach ($transactions as &$transaction) {
                    ...
                    if (in_array($transaction['type'], array('authorize', 'authorize3d', 'capture', 'sale', 'sale3d', 'init_recurring_sale', 'recurring_sale', 'refund')) && $transaction) {
                        ...
                        $transaction['void_exists'] = $this->model_payment_emerchantpay_checkout->getTransactionsByTypeAndStatus($orderId, $transaction['unique_id'], 'void', 'approved') !== false;
                    } else {
                ...
                $data = array(
                    ...
                    'emerchantpay_checkout_supports_void'            => $this->config->get('emerchantpay_checkout_supports_void'),

                    'order_id'                                  => $orderId,
                    'token'                                     => $this->request->get['token'],
                    'url_modal'                                 => htmlspecialchars_decode($this->url->link('payment/emerchantpay_checkout/getModalForm', 'token=' . $this->session->data['token'], 'SSL')),
                    'module_name'				                => $this->module_name,
                    'currency'		                            => $this->getTemplateCurrencyArray(),
                    'transactions'                              => $transactions,
                );

                return $this->load->view('payment/emerchantpay_checkout_order.tpl', $data);
            }
        }
    ...
    public function getModalForm()
    {
        if (isset($this->request->post['reference_id']) && isset($this->request->post['type'])) {
            ...
            $ref_id  = $this->request->post['reference_id'];
            $type    = $this->request->post['type'];
            $orderId = $this->request->post['order_id'];
						
            $transaction = $this->model_payment_emerchantpay_checkout->getTransactionById($ref_id);
						
            if ($type == 'capture') {
                $totalAuthorizedAmount           = $this->model_payment_emerchantpay_checkout->getTransactionsSumAmount($orderId, $transaction['reference_id'], array('authorize', 'authorize3d'), 'approved');
                $totalCapturedAmount             = $this->model_payment_emerchantpay_checkout->getTransactionsSumAmount($orderId, $transaction['unique_id'], 'capture', 'approved');
                $transaction['available_amount'] = $totalAuthorizedAmount - $totalCapturedAmount;
            }
            else if ($type == 'refund') {
                $hasVoidTransaction = $this->model_payment_emerchantpay_checkout->getTransactionsByTypeAndStatus($orderId, $transaction['unique_id'], 'void', 'approved');
                if (!$hasVoidTransaction) {
                    $totalCapturedAmount             = $transaction['amount'];
                    $totalRefundedAmount             = $this->model_payment_emerchantpay_checkout->getTransactionsSumAmount($orderId, $transaction['unique_id'], 'refund', 'approved');
                ...
                $transaction['is_allowed'] = $this->model_payment_emerchantpay_checkout->getTransactionsByTypeAndStatus($orderId, $transaction['unique_id'], 'void', 'approved') == false;
            }

            $url_action = $this->url->link('payment/emerchantpay_checkout/' . $type, 'token=' . $this->session->data['token'], 'SSL');
            ...
            $data = array(
                ...
                'emerchantpay_checkout_supports_partial_capture'   => $this->config->get('emerchantpay_checkout_supports_partial_capture'),
                'emerchantpay_checkout_supports_partial_refund'    => $this->config->get('emerchantpay_checkout_supports_partial_refund'),
                'emerchantpay_checkout_supports_void'              => $this->config->get('emerchantpay_checkout_supports_void')

            );

            $this->response->setOutput(
                $this->load->view('payment/emerchantpay_checkout_order_modal.tpl', $data)
            );
        }
    }
    ...
    public function capture()
    {
        ...
        if (isset($this->request->post['reference_id']) && trim($this->request->post['reference_id']) != '') {
            ...
            $transaction = $this->model_payment_emerchantpay_checkout->getTransactionById($this->request->post['reference_id']);
            ...
            if (isset($transaction['order_id']) && abs((int)$transaction['order_id']) > 0) {
                ...
                $capture = $this->model_payment_emerchantpay_checkout->capture($transaction['unique_id'], $amount, $transaction['currency'], $message, $transaction['terminal_token']);
                ...
                if (isset($capture->unique_id)) {
                    ...
                    $data = array(
                        ...
                        'timestamp'         => $timestamp,
                        'terminal_token'    => isset($capture->terminal_token) ? $capture->terminal_token : $transaction['terminal_token'],
    ...
    public function refund()
    {
        ...
        if (isset($this->request->post['reference_id']) && trim($this->request->post['reference_id']) != '') {
            ...
            if (isset($transaction['order_id']) && abs((int)$transaction['order_id']) > 0) {
                ...
                $refund = $this->model_payment_emerchantpay_checkout->refund($transaction['unique_id'], $amount, $transaction['currency'], $message, $transaction['terminal_token']);
                ...
                if (isset($refund->unique_id)) {
                    ...
                    $data = array(
                        ...
                        'timestamp'         => $timestamp,
                        'terminal_token'    => isset($refund->terminal_token) ? $refund->terminal_token : $transaction['terminal_token'],
    ...
    public function void()
    {
        ...
        if (isset($this->request->post['reference_id']) && trim($this->request->post['reference_id']) != '') {
            ...
            if (isset($transaction['order_id']) && abs((int)$transaction['order_id']) > 0) {
                ...
                $void = $this->model_payment_emerchantpay_checkout->void($transaction['unique_id'], $message, $transaction['terminal_token']);
                ...
                if (isset($void->unique_id)) {
                    ...
                    $data = array(
                        ...
                        'timestamp'         => $timestamp,
                        'terminal_token'    => isset($void->terminal_token) ? $void->terminal_token : $transaction['terminal_token'],
    ...
    {
        $this->load->model('payment/emerchantpay_checkout');
        $this->model_payment_emerchantpay_checkout->install();
    }
    ...
    {
        $this->load->model('payment/emerchantpay_checkout');
        $this->model_payment_emerchantpay_checkout->uninstall();
    }
    ...
    {
        if (!$this->user->hasPermission('modify', 'payment/emerchantpay_checkout')) {
            $this->error['warning'] = $this->language->get('error_permission');
        }

        if (@empty($this->request->post['emerchantpay_checkout_username'])) {
            $this->error['username'] = $this->language->get('error_username');
        }

        if (@empty($this->request->post['emerchantpay_checkout_password'])) {
            $this->error['password'] = $this->language->get('error_password');
        }

        if (@empty($this->request->post['emerchantpay_checkout_transaction_type'])) {
    ...
    protected function isUserLoggedInAndAuthorized()
    {
        ...
        $hasAccess  = $this->user->hasPermission('access', 'payment/emerchantpay_checkout');
