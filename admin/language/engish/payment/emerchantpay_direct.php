...
$_['help_sandbox']                  = 'Use Sandbox (Test) mode or Production (Live) gateway.<br/><br/>Keep in mind in Sandbox (Test) mode - NO MONEY ARE BEING TRANSFERRED.';
$_['help_order_status']             = 'Order status for successfully completed transactions.';
$_['help_order_status_async']       = 'Order status for initiated asynchronous (3D) transaction.';
